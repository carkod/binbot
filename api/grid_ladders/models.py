...
from pybinbot import ExchangeId, GridLadderStatus, MarketType, StandardResponse
...
class GridLadderResponse(StandardResponse):
    data: GridLadderRecord | None = None


class GridLadderListResponse(StandardResponse):
