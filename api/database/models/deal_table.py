...
class DealBase(SQLModel):
    ...
    margin_short_base_order: float = Field(default=0, description="To be merged with base_order")
    ...
    opening_price: Optional[float] = Field(default=0, description="replaces previous buy_price or short_sell_price/margin_short_sell_price")
    opening_qty: Optional[float] = Field(default=0, description="replaces previous buy_total_qty or short_sell_qty/margin_short_sell_qty")
    opening_timestamp: Optional[int] = Field(default=0, sa_column=Column(BigInteger()))
    closing_price: Optional[float] = Field(default=0, description="replaces previous sell_price or short_sell_price/margin_short_sell_price")
    closing_qty: Optional[float] = Field(default=0, description="replaces previous sell_qty or short_sell_qty/margin_short_sell_qty")
    closing_timestamp: Optional[int] = Field(default=0, description="replaces previous buy_timestamp or margin/short_sell timestamps", sa_column=Column(BigInteger()))
